      ...
      <div className="container mx-auto px-4 py-20">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            <div>
              <h2 className="font-display text-3xl font-bold text-gray-100 mb-6">Let's Connect</h2>
              <p className="elegant-text text-lg mb-8">
              ...
              <div className="space-y-6">
                <div className="group flex items-center space-x-4 p-4 rounded-xl hover:bg-blue-50 transition-colors cursor-pointer">
                  ...
                  <div>
                    ...
                    <p className="elegant-text">gagan@example.com</p>
                  </div>
                </div>
                ...
                <div className="group flex items-center space-x-4 p-4 rounded-xl hover:bg-blue-50 transition-colors cursor-pointer">
                  ...
                  <div>
                    ...
                    <p className="elegant-text">linkedin.com/in/gagan</p>
                  </div>
                </div>
                ...
                <div className="group flex items-center space-x-4 p-4 rounded-xl hover:bg-blue-50 transition-colors cursor-pointer">
                  ...
                  <div>
                    ...
                    <p className="elegant-text">github.com/gagan</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    id="message"
                    rows={5}
                    className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all bg-white resize-none"
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-4 px-6 rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl font-semibold"
                >
                  Send Message
                </button>
              </form>
